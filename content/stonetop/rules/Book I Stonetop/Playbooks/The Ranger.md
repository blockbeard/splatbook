...
Pick 2, in addition to your composite bow.

- [x] ◇ **Composite bow** (*far*, +1 damage, *x* piercing; ○ low ammo, ○ all out)
...
- [ ] **Lay of the land** (3 uses): expend a use to know where to find \_\_\_, without having to Know Things; GM can veto.
