...
- [ ] **MISSIONARY**
    ...
    - [x] Devin (from Marshedge)
    - [x] Haeris (from Gordin's Delve)
...
Pick 1, in addition to your symbol of authority and scribe's tools.

- [x] **Your symbol of authority** (pick 1):
...
- [x] **Scribe's tools**: parchment, ink, pigments, vials, quills, ◇ a notebook, etc.
