...
> [!abstract]- Printable playbook (2nd-printing PDF, Book I pp. 125–128)
> ^printable-playbook-2nd-printing-pdf-book-i-pp-125-128
...
- [ ] **Steplands** (Hillfolk): Adl, Aeln, Clotild, Judoc, Katrn, Mygl, Pirn, or Sera
...
**I am called…** \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

## Stats

Assign these scores: **+2, +1, +1, +0, +0, −1**. When a debility is marked, you roll with disadvantage.

| Strength (STR) | Dexterity (DEX) | Intelligence (INT) | Wisdom (WIS) | Constitution (CON) | Charisma (CHA) |
|:---:|:---:|:---:|:---:|:---:|:---:|
|     |     |     |     |     |     |
...
| Damage | HP (max 20) | Armor | XP | Level |
|:---:|:---:|:---:|:---:|:---:|
| d8 |    |    |    |    |
...
*(Requires level 2+, the Marshal; may be taken twice)*
...
*(Requires Crew; may be taken twice)*
...
*(Requires Read the Land; Surprise tracker: 2)*
...
When you *Clash and get a 7+*, you can choose to deal damage with disadvantage. If you do, you create an opening for ally to act on, as if you provided Aid. Describe it!
...
- Can I trust them (to \_\_\_\_\_\_ )?
...
*(Requires level 6+ and Veteran Crew; may be taken twice)*
...
- [ ] **Distillery**: skins of fine whisky (2 uses, grants advantage to Persuade), copper tubes, malt, ◇◇ firkins, stills, barrels, etc.
...
- [ ] \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ (discuss with GM)
