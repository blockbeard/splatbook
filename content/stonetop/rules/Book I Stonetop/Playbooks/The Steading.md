...
*(A full-page illustrated map of the village, with lettered markers.)*
...
- **F** — Watchtowers
- **G–R** — \_\_\_ (write-in lines for new places)
...
**Excluded content** (Not part of the game, on-camera or off) — write-in lines.

**Veiled content** (Part of the fiction, but only off-camera) — write-in lines.

**Special handling** — write-in lines.
...
- [ ] Pulling together 5 times *(5 boxes)*, each requiring 1 season, 1 Surplus, and a wagonload of timber and other supplies (Value 2), to (re)build homes.

When you **meet the requirements**, increase Fortunes by 1 and add any new homes to the map.
...
- [ ] A successful first hunt (played out in detail)
...
**Requires** one of the following improvements, to free up enough time to support more tradesfolk:
...
When you **meet the requirements**, increase Fortunes by 1.
...
When you **meet the requirements**, add it to the Resources list and increase Fortunes by 1.
...
- [ ] Pulling Together to build the stable and corral, which requires a month and a wagonload of timber (Value 2). Add them to the map.
...
- [ ] Pulling Together to have a couple dozen villagers learn to ride, requiring a season and 1 Surplus.
- [ ] Someone to mind the herd and stable, full time

When you **meet the requirements**, increase Fortunes by 1 and replace "a pair of sturdy draft horses" with "a herd of horses" on the Assets list. Make a note of its size. Henceforth:
...
When you **meet the requirements**, gain the following move:
...
- [ ] Pulling Together 2 times *(2 boxes)*, each requiring 1 season, 1 Surplus, and timber/supplies (Value 2)
- [ ] A small, devoted staff (innkeep, cook, ostler, etc.)

When you **meet the requirements**, increase Fortunes by 1. Name the inn, add it to both the Resources list and map.
...
- [ ] Four seasons in operation *(4 boxes)* without notable incidents of violence, banditry, theft, etc.
...
- [ ] Pulling Together 2 times *(2 boxes)*, each requiring a season, 1 Surplus, a wagonload of timber (Value 2), and a bunch of rope and supplies (Value 2)
- [ ] A full-time miller

When you **meet the requirements**, increase Fortunes by 1, add "Mill" to the Resources list and draw it on the map.
...
- [ ] Pulling Together 3 times *(3 boxes)*, each requiring 1 season and 1 Surplus
...
When you **meet the requirements**, add "standing watch" to the Fortifications list. **At the start of each season**, the watch consumes 1 Surplus or it disbands.
...
- [ ] Pulling Together 4 times *(4 boxes)*, each costing 1 season, 1 Surplus, and supplies (Value 2)

When you **meet the requirements**, add "Stone Wall" to the Fortifications list (erase "Palisade" if you had it) and draw it on the map. Henceforth:
...
- [ ] Population +3 for 4 consecutive seasons *(4 boxes)*
- [ ] Additional Housing
- [ ] Raincatching OR Diverting the Stream
- [ ] At least 4 other improvements *(4 boxes)*
- [ ] A formal government of some sort

When you **mark all of the requirements**, change Size to *town* and its Population to +0. Henceforth:
...
- [ ] 4 seasons of work by the smith *(4 boxes)*
...
When you **meet the requirements**, increase Defenses by 1 and add "Weapons of War" to the Fortifications list. **Each spring**, the village must expend 1 Surplus to maintain and replace the town's weapons.
...
For each tactic below, you must then Pull Together, requiring a season of drills and 1 Surplus.
...
- [ ] Skirmishing: ambushes, harrassing, hit-and-run
...
Additional possible Improvements, revealed by the GM.

*(Six blank improvement cards, each with: checkbox + name line, Summary, Requirements, Effects.)*
...
- \_\_\_ (seven write-in lines)

**Silver**: Purses / Handfuls / Coins

**Gold**: Purses / Handfuls / Coins

## Residents of Stonetop

Add each NPC that is named during introductions or play. Give each an occupation (even if just farmer or homemaker) and at least 1 trait.

Columns: **Name (pronouns)** · **Occupation** · **Traits, relations, etc.**

Pre-filled occupations (names blank): publican, smith, tanner, potter, midwife.
...
Add NPCs from neighboring areas when instructed by a playbook, or as needed.

Columns: **Name (pronouns)** · **Home** · **Occupation** · **Traits, relations, etc.**

## Neighboring places

- **Marshedge** — NOTES. **Names:** Abben, Ailen, Brin, Brogan, Catlin, Coln, Daedre, Dermos, Ennin, Finnen, Gilor, Isbeal, Kiran, Lile, Lim, Mathuin, Mirne, Noren, Owan, Ragan, Renan, Seadha, Seann, Tierney, Ulliam
- **Gordin's Delve** — NOTES. **Names:** Choose from other lists; everyone comes to Gordin's Delve from somewhere else.
- **The Steplands** (Hillfolk) — NOTES. **Names:** Adm, Blej, Cirl, Davth, Elst, Gwilm, Gwenl, Henri, Ines, Jenfir, Jown, Juda, Kiln, Laurl, Loic, Merrn, Maikl, Nanzl, Nolwn, Quent, Reegn, Ropr, Sabi, Stren, Yanz
- **Lygos** (and other points south) — NOTES. **Names:** Agatte, Aref, Alix, Baraz, Canan, Darya, Demetra, Elene, Elios, Fotios, Faruza, Golza, Iasos, Iona, Kyriakos, Marika, Maayan, Osher, Natasa, Nivola, Rinat, Stamat, Thecla, Zhaleh
- **Other places** (Barrier Pass, the Manmarch, etc.) — NOTES.
