...
- **Clues**, like a monster's footprints in the muddy soil
- **Sites**, like the monster's den
- **Encounters**, like the curious spirit met while following the monster's tracks
- **Opportunities**, like the eggs found in the monster's den
- **Artifacts**, like the strange medallion tucked in the nest with the eggs
- **Arcana**, like the lime-caked runes carved in the walls of the den, detailing a spell that can hide you from death

These aren't formal categories, and they often overlap. Those footprints might be a clue that the monster is nearby, but they might also be an opportunity to track it down or find its den.

Discoveries can also be **[[09 - Threats#Threats|threats]]** or **[[12 - Dangers#Dangers|dangers]]**. An aurochs quietly munching away is a discovery—a chance to acquire meat and valuable horns! But it's also a monster, one that could really mess the PCs up if they aren't careful.

Add discoveries to the game when…

- … **a player move prompts you to**. When a PC Seeks Insight and asks, "What happened here recently?" your answer might take the form of a clue. When they Forage and pick, "You discover something interesting or useful," you're almost certainly going to present them with a discovery of some sort.
...
*Vahid has dragged the PCs to Three Coven Lake, in search of the Mindgem's fiery makerglass heart. He's acquired an ancient scroll that hints at it once being here, powering some arcane device.* 

*In order to accomplish their goals, the PCs will need to learn where exactly the Mindgem's heart is. I've decided that it's still powering that arcane device, which animates a number of constructs. But a deathless sorcerer long ago fused his soul to that device, sending his consciousness out into those constructs.* 

*I think about potential clues, ways that the PCs could learn some or all of this. Then I write out the following:* 

- An old map of the city, showing a site marked with a sigil that's also prominent on the scroll.
- The constructs bear that same sigil from the scroll; the PCs might interrogate one or follow it home.
- A rival of the sorcerer tells the PCs where to find the arcane device, hoping to stir up conflict.

*(And now I start thinking about who or what the sorcerer's rival might be, and how the PCs might encounter them…)*

**Decide where and how the PCs could find any clues you prepare**. Some clues will be tied to a specific place, NPC, or monster. Other clues will be notional, things you can introduce whenever and wherever it makes sense.

If you suspect that a clue will prompt your PCs to Know Things or Seek Insight or use some other information-gathering move, consider what information you might provide. Maybe write down something interesting and something useful, or what isn't what it seems, etc.

*Continuing the previous example, the second and third clues are clearly tied to encounters with specific entities. But the first clue—the map—could theoretically be found anywhere in the ruined city.* 

*I suspect that Vahid will Know Things about that sigil if he finds it on the map or the constructs, so I jot down:*

SOMETHING INTERESTING: This sigil is a personal identifier for a maker named Skol Gaeille. Such sigils were used to mark an individual's property.

SOMETHING USEFUL: That spot on the map/wherever these constructs come from… there's a good chance that you'll find the arcane device there or at least a lead to find it!
...
See [[11 - Sites#Creating sites|Creating sites]] for the full process, and [[11 - Sites#Running sites|Running sites]] for guidance on **running sites**.
...
The more specific the answers, the more interesting the encounter! "Migrants on their way to Gordin's Delve, in need of aid" is a good encounter! But "A family from Marshedge, going to join their father in Gordin's Delve, and whose donkey (and all it carried) has wandered off the road" is much more compelling.

If you're improvising, you'll answer many of these questions instinctively, or already have some answers from context. Great! Start with what's obvious, and add specific details as you frame the encounter and play out the scene.

If you're prepping, you might leave some questions unanswered, or answer them with possibilities instead of specifics. Even answers you think are set in stone might change in response to events in play.
...
*As for this encounter's purpose and stakes: I think this guy will be fun to play, and he's got lots of potential to help, hinder, and frustrate the PCs!*
...
As you run the encounter, elaborate and riff on what you've already established. You'll probably do this naturally as the players ask questions and you clarify the situation, or in order to resolve PC actions.

Build the NPCs into actual characters, with names, core concepts, memorable traits, impressions, and so forth. If the encounter is with a group, embellish specific individuals as they come into focus. If you're stumped for details, **ask the PCs questions and build on the answers**.

If you've established the instinct, tags, and moves of an NPC, use them to inform how you portray them and run the scene.

Keep the encounter's purpose and stakes in mind. **Zoom to an appropriate level of detail, and don't be afraid to wrap a scene up when its purpose has been fulfilled**. For example, if you add an encounter with the intent of just adding a little color, and the PCs react as if it's some sort of pivotal scene, step out of character and address the players. "Folks, no, this is just a tinker on the road and not some sort of threat. Let's move on." But at the same time, be open to the possibility that this encounter is more important or meaningful than you planned. Maybe that tinker has some key information to share after all!
...
- A good spot to \_\_ (make camp, set an ambush, take shelter, etc.)
- A way to get somewhere (a key, a short cut, a hidden passage, a ford, etc.)
- A chance to \_\_ (learn something, get a drop on a foe, impress someone, etc.)
...
- An **[[13 - Discoveries#Arcana|arcanum]]**
...
Artifacts are things laden with meaning, power, or value. They're objects that the PCs might take with them, or come back later to claim. Relics of the past, gems and finery, magic items—treasure, basically!
...
About 4 feet tall, made of thick shell-like material, and fitted with a heavy lid. When the *urn is unoccupied and a Fae looks inside*, it is compelled to crawl in (it can always fit). If you *then close the lid*, the Fae is trapped and the urn slowly and painfully peels away its knowledge, essence, and sense of self. In time, nothing remains but a pile of pearls (Value 2).

A handful of artifacts are presented as **[[15 - Homefront#Steading improvements|steading improvements]]**, and many **[[13 - Discoveries#Arcana|arcana]]** are some sort of artifact. You can create your own, too; see [[13 - Discoveries#Creating artifacts|Creating artifacts]].
...
If the PCs want to leverage an artifact to achieve some long-term goal, then Make a Plan or write up a new steading improvement to reflect their idea, whichever makes the most sense.

*They open the urn and sift through the junk. "Are there markings inside?" asks Vahid. "Or anything else to explain that calling Blodwen feels?" I'm not sure, so I ask Vahid if he's Knowing Things about the urn. He is, and he rolls a 7.*

*"Something interesting… It's clearly the work of a Green Lord. And the magic is a compulsion that affects Fae. So how do you know this?" We decide that there are flowing runes along the urn's inside, some of which Vahid can decipher.* 

*"It was made by the Green Lords? I'm Well Versed in the Makers and their arts, so I get a follow-up question. What exactly does this urn do?"* 
...
Likewise, **if the artifact itself is a source of trouble**, write it up as a threat, probably a *magical entity* or an *affliction*.
...
If an artifact has a Value "to the right buyer," then PCs could:

- Know Things to identify a buyer, then send them word or seek them out
- Wait for a trade opportunity (from Seasons Change) with such a buyer
- Make a Plan to sell it at full Value
- Use Trade & Barter to sell it for it a

Artifacts with no listed Value count as unique items: they can't be sold via Trade & Barter. As above, the PCs can Know Things or Make a Plan to find a buyer, or wait for a trade opportunity. If they find a buyer, assign the artifact a Value, typically 2 or 3 but sometimes as much as 4.
...
If a PC wants to acquire such an artifact, they might:

- Know Things about where such things can be found, or who might have one (and then attempt to acquire it)
- Make a Plan with the GM
...
Appendix B includes a detailed procedure for artifact creation. Use it when none of the existing artifacts in *Book II* meet your needs, or when you have an idea for an artifact that you want to flesh out. Or, just use it because you want to—making artifacts is fun!

To create a new artifact:

- 1) Determine its **origin and theme**
- 2) Determine its **nature** and any related characteristics
- 3) Determine its **form**
- 4) **Synthesize** these details
- 5) **Write it up**, however makes sense

These steps are presented in order, but they can generally work in whatever order makes sense to you. Maybe you find it more effective to pick an artifact's form prior to picking its nature! That's fine.
...
If you already know where the artifact came from, just pick. If a few different origins seem likely, either choose one for now (and feel free to change your mind later) or pick between them randomly.

Each of the possible origins in *Book II* has a table of related themes. Pick from or roll on the appropriate theme table. Allow the theme(s) to inform everything else about the artifact.
...
Each result on the nature table points to another table, or set of tables, to determine its characteristics. Pick from or roll on these sub-tables as well. Then follow their instructions (which might send you to other characteristics, to its form, etc.).
...
From there, pick from or roll on the what is it tables. Interpret these results liberally, keeping the origin, theme, and nature in mind. Let yourself be inspired!
...
It's okay to change or discard some of the details you established earlier, or interpret them loosely or metaphorically. They're meant to spur your creativity, not limit it.
...
Silver filigree sphere, fist-sized, vine-and-plant patterns (beautiful, Value 2)
...
*I run through the first three steps and end up with an origin of Aratis and a theme of "laws/rules/traditions." It's redwood, with an extraordinary property of "fills those who look upon it with \_\_." It's "a item," with a form of "Fire: incense, oil, candle, lamp, lantern, sconce, brazier, hearth, etc."*
...
An arcanum is a card or playbook insert, something you give the players. Each one represents a discovery—an artifact, a place, a bit of lore, a magical effect, etc.— with mysteries that the PCs can unlock. "Arcanum" is a game term; it's not something characters are likely to refer to in-fiction.

The front of an arcanum describes what the PC can tell at a glance or with a little effort, plus the requirements for unlocking its mysteries. The back shows those mysteries, which can include custom moves, new options, followers, and consequences.
...
*The Ruined Tower entry in* Book II *includes a number of discovery tables for the outer ruins, including one for "something valuable." I roll and get "a half-buried plaque, or some other artifact of the Tempest Lords." The halfburied plaque seems like a perfect thing to find in the blasted rubble around the Tower.*

.

*I pause to consider whether I want to add this arcanum to the game. It's right up Vahid's alley, and while he has a few stilllocked arcana, he can't easily act on them just yet (one requires that he suffer a terrible burn; another needs Rhianna's help and she's busy; the third involves finding pieces of the Mindgem's body and he has no leads.) This is an arcanum he could act on now, and one that I think would be fun to see in play.* 
...
When the PCs discover an arcanum, you might…

- … **just give the player(s) the card** and have them read it, front and back. Maybe the PC doesn't know all this info yet; work with the player to figure out how and when they figure it out.
...
Also, **bring it home**. Ask what chores they're neglecting or who they get to cover for them. Think about how NPCs in the village react. Who might be affected, or put at risk, or confront the PC? Use your homefront **[[09 - Threats#Threats|threats]]** and **[[15 - Homefront#Homefront|moves]]** here.
...
When an arcanum's requirement says that they "risk \_\_," it almost certainly involves Defying Danger. Maybe you **put them in a spot**, and ask, "What do you do?". Or maybe you stay zoomed out and ask how they deal with the risk at a high level, using their approach to decide what stat they should roll and what the possible outcomes might be.
...
If the PCs share a major arcanum with each other, then in general:
...
- … you can envision a meaningful set of steps for unlocking its mysteries
- … once unlocked, it provides a lasting, repeatable, and/or renewable benefit, and…
- … you think you can describe it and its benefits concisely, in ~300 words or less (~150 words per side).

Good candidates include artifacts that house a spirit or sentience, or that convey the workings of a spell/ritual/technique, or that produce a recurring magical effect.

Alternatively, you might have an idea for some other discovery—a clue, a site, an encounter—that meets the criteria above. You might still walk through the artifact creation process to conceptualize the idea, but either skip the Form step or interpret it very loosely.

With the arcanum's concept in mind, write the following, in whatever order works for you:

- Its initial title
- Its tags and other elements
- A brief description
- The requirements for unlocking it
- Its unlocked title
- Its mysteries

Expect the process to be iterative. You'll often go back and revise earlier parts as you work, maybe even rethinking its core concept. That's fine and normal.

### **Initial title**

Write a short, simple phrase describing what the arcanum appears to be. A minor arcanum card can fit ~20 characters of 12-point type, so aim for that.
...
- … deciphering/studying something;
- … learning something, or figuring it out;
- … finding/acquiring something;
- … getting help from someone/thing;
- … convincing someone/thing to \_\_;
- … days/weeks/months/seasons of effort;
- … a certain skill or talent;
- … making/repairing/finishing something;
- … paying a cost/making a sacrifice;
- … undergoing an ordeal/challenge;
- … a ritual/rite/observance;
- … something bloody/weird/extreme;
- … labor/effort/practice/hard work;
- … a simple custom move;
- … risking \_\_ (harm, collateral damage, failing to master it, ruining it, etc.);
...
Edit aggressively, boiling your text down to the bare essentials while maintaining clarity. You can fit only ~150 words on the back of a minor arcanum card.
...
- … you're willing to do a fair amount of work to create it;
- … you're okay with it being a significant part of your ongoing game;
- … you can see how it'd be immediately useful (or at least interesting);
- … you picture it growing in power with effort or as the PC uses it; and…
- … you can imagine an escalating series of consequences from using it.

Start with the arcanum's concept—its core themes, what it is, and what it does. Like, "a Fae-made mirror that creates resentful copies of yourself," or, "a shard of divine essence that burns away your flesh and replaces it with holy flame." If you haven't already, use the **creating artifacts** process [[13 - Discoveries#Creating artifacts|Creating artifacts]] to help conceptualize it, but don't feel constrained by that process.

Each major arcanum works differently, but almost all have these common elements. Flesh them out in whatever order works for you:

- Its title, tags, and a brief description
- Its starting moves
- How it's unlocked
- Its mysteries
- Its consequences
...
Draw it or find a picture to represent it, something to place at the top of the insert.
...
- … successfully using one of the arcanum's starting moves \_\_ times;
- … rolling a 6- on one of the initial moves \_\_ times (suffering the consequences each time);
- … paying a certain cost \_\_ times;
- … collecting specific items or bits of lore;
- … performing certain tasks or rituals;
- … spending weeks practicing/studying/ contemplating the arcanum;
- … experiencing some extreme event(s);
...
If there are multiple mysteries to unlock, decide how that works. The PC might…

- … unlock them all at once;
- … unlock additional mysteries the same way they unlocked the first one (using the starting move, paying a cost, etc.);
- … unlock further mysteries after marking a certain number of consequences; or…
- … do something else to unlock them.

See [[16 - Writing Moves and Love Letters#Writing moves|Writing moves]] for advice on **writing custom player moves**. Look to other major arcana for inspiration, but don't be afraid to try something new and unique.
...
Make 2-3 of the consequences not-so-bad, maybe even beneficial. But by the time the player is marking the fourth or fifth one, things should be feeling grim.

Consequences might involve…

- … suffering harm/debilities/conditions;
- … physical mutations/changes;
- … changes to the PC's perceptions, thought processes, and/or instinct;
- … benefits like +1 Armor, increased HP, resistance to certain harms, etc.;
- … changes to how others perceive the PC
- … introducing a new threat or danger
- … unwanted attention;
- … new, problematic custom moves;
- … a task the PC must perform;
- … chaos wrought upon the larger world;
- … the loss of the arcanum or its powers;
- … some combination of the above; or…
- … anything else that makes sense.
