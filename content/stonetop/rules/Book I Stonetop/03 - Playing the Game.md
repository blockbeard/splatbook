...
For more on the GM's agenda, see [[05 - Running the Game#Your agenda|Your agenda]].
...
- ... **[[06 - Player Moves#Player Moves|trigger a player move]]**, follow the move's procedures.
...
**The process then repeats**. The GM reestablishes the situation, gives it a nudge, and asks, "What do you do?"
...
Many moves are shared by all players (see [[06 - Player Moves|Player Moves]]). Other moves are specific to your **[[03 - Playing the Game#Your character|playbook]]**, an **[[03 - Playing the Game#Inserts|insert]]**, or an **[[03 - Playing the Game#Arcana|arcanum]]**. Other moves will be custom-made for specific situations [[06 - Player Moves#Custom moves|Custom moves]].
...
Many moves tell you to "roll +STAT" (usually with a specific stat, like STR or INT, see [[03 - Playing the Game#Stats|Stats]]).
...
<sup>+</sup> <sup>+</sup> <sup>+</sup> + 1 = **10** X
...
Advantage and disadvantage normally stem from a move or condition. The GM can apply them ad hoc if they deem a roll especially hard or easy, but they're encouraged not to. See [[03 - Playing the Game#ADVANTAGE/DISADVANTAGE|Advantage/disadvantage]].
...
- **[[03 - Playing the Game#XP|You mark XP]]**, unless the move says otherwise
...
For more details, see the **Running the Game** chapter [[05 - Running the Game|Running the Game]]. For more on fights specifically, see **[[12 - Dangers#Running combat|Running combat]]**.
...
There will be times when you and other PCs come into conflict. You might **[[06 - Player Moves#PERSUADE (vs. PCs)|Persuade]]** another PC to go along with your plan. They might **[[06 - Player Moves#SEEK INSIGHT|Seek Insight]]** to figure out what you're up to. You might **[[06 - Player Moves#INTERFERE|Interfere]]** to keep them from doing something they'll regret, or something *you'll* regret.
...
Following these principles will lead you to achieving your **[[03 - Playing the Game#Your agenda|agenda]]**. Strive to follow them, always.
...
Explore the relationships between your character and the other PCs. Play out scenes with each other, speaking in your character's voices. Go out of your way to interact with each other, to care about each other, and to get involved in each other's lives.
...
Take decisive action that moves the game and situation forward. You're the PCs, the folks that Stonetop looks to save them when danger looms. If you don't act like a hero, who will?
...
**Watch for moves triggering.** It's everyone's job to call out when moves trigger, or to question it when someone invokes a move without its trigger being met. "This feels like you're enticing her… Persuade?" "Is this really Defy Danger? Like, what's at stake?"

**Work the fiction.** Describe your actions in such a way that you trigger the moves you want to use, and avoid triggering moves you don't want to make. Exploit details of the established fiction, or suggest new ones that you think might help.
...
**Don't keep secrets from other players.** It's fine for your character to keep secrets from the other PCs. Heck, that's great! But the other players should be in on it, able to enjoy the dramatic irony.
...
There are nine standard **playbooks**, which you can find starting on [[04 - Playbooks and Inserts|Playbooks and Inserts]]. In play, though, you'll use either a printed copy of your playbook or an electronic version thereof. You can download these playbooks (and other materials) from www. lampblackandbrimstone.com.
...
Your instinct describes how your PC tends to behave, for better or for worse. If you demonstrate your instinct in play, or struggle against it, you get to mark XP at the **[[06 - Player Moves#END OF SESSION|end of the session]]**.
...
Your instinct can change during play. You'll be prompted to consider doing so each time you **[[03 - Playing the Game#DEPLOY|Level Up]]**, but you can change your instinct any time it feels right to do so. Pick something else (from your playbook or another), or make up a new one. Just be sure to let the GM and the other players know.
...
Each origin provides a list of names to pick from. You don't have to pick one of the suggested names, but the lists are meant to give the world a cohesive feel. If you want something different, the **[[The Steading|steading playbook]]** includes additional names from each locale. Or you can search online for similar names.
...
- **Dexterity (DEX)**: your grace and fine motor control. Roll +DEX to Let Fly, or to Defy Danger with speed, agility, finesse.
...
- **Wisdom (WIS)**: your intuition, selfcontrol, and awareness. Roll +WIS to Seek Insight, or when you rely on your willpower or senses to Defy Danger.
...
You can increase your stats by taking the **Improved Stat** or **Superior Stat** playbook moves (see [[The Blessed#AMULETS & TALISMANS|Amulets & Talismans]] an[[The Blessed#SUPERIOR STAT|d 107]]).
...
Debilities last until a move like **[[10 - Expeditions#RECOVER|Recover]]** or **[[10 - Expeditions#MAKE CAMP|Make Camp]]** tells you to clear them, or until the GM tells you to.
...
You regain HP via moves like **[[10 - Expeditions#RECOVER|Recover]]** or **[[10 - Expeditions#MAKE CAMP|Make Camp]]**, but your current HP can never go higher than your max.
...
- ... **[[06 - Player Moves#END OF SESSION|as part of the End of Session move]]**; and
- ... **when another move says so**.

"Mark XP" means that you make a tick mark in the XP box on your playbook, increasing your total XP by 1. Like so:

Once you've marked enough XP, you can spend it to either **[[06 - Player Moves#BURN BRIGHTLY|Burn Brightly]]** or **[[03 - Playing the Game#DEPLOY|Level Up]]**.

Your level reflects how much your PC has grown in competence and capability. You start at level 1. When you mark XP equal to 6 plus twice your current level, you can take some downtime and spend that XP to **[[03 - Playing the Game#DEPLOY|Level Up]]**.
...
If you're making a new character to join an ongoing game, you still start at level 1, no matter what level the other PCs are at. Don't worry about "power imbalance." A low-level PC doesn't have quite the range of options that a high-level one has, but they're still
## **Special possessions**
...
Each playbook has a selection of moves. You'll start play with 3 or 4 of them; your playbook tells you which, or which to choose from. Each time you **[[03 - Playing the Game#DEPLOY|Level Up]]**, you get a new move from your playbook.

Some playbook moves lack **[[03 - Playing the Game#Triggers|triggers]]**; you simply gain their benefit when you take them. If you take the Improved Stat move, you permanently increase one of your stats. If you take a move that lets you always ask something, you can just do that now!

If a move says "(Requires \_\_)," then you must meet that requirement in order to take the move. The requirement might be a level, another move, or the specific playbook (meaning that other playbooks can never take this move, even when they take a move that lets them pick from another playbook, see below.)
...
Expect the GM to ask questions about this stuff. When and where did this happen? Who else was involved? How'd you end up there in the first place? Etc. It's good to think a little about this in advance, but as always, hold your ideas lightly. You might want to change them a bit once you hear what the other players have to say.

## **Introductions**

Each playbook ends with a procedure for introducing your character to the group. This is to meant to happen during the first session, after you all choose and fill out your playbooks. The GM will walk the group through it, together, asking lots of questions. Pay attention to the other players, ask questions yourself, and riff on the details they provide.
...
## . minor arcanum . **An old scroll case** , *fragile* A leather scroll case, cracked and ageworn. Inside is a tattered letter and a pair of small, bluish ingots. It's a letter, in an older Hillfolk dialect, from an apprentice to their master. It describes a mental exercise to draw latent power from aetherium. You can learn **Laoj Davith's Galvanic Infusion** from the scroll, but… ... you must translate the letter. ... it'll take a few weeks of dedicated study. ... you'll use up one of the aetherium ingots (or another source of aetherium). ... you risk electrocuting yourself and/ or using up the other ingot. **1** front

When a requirement says that "you risk \_\_\_," then you'll be **[[06 - Player Moves#DEFY DANGER|Defying Danger]]** unless you can come up with some way of eliminating that risk. Learning magic is rarely easy or safe.

Meet the requirements, and you unlock its mysteries. You gain whatever move and/or follower appears on the back of the card.
...
- ... they'd need to acquire a couple pieces of aetherium before trying to unlock its mysteries themselves;
- ... you might **[[06 - Player Moves#AID|Aid]]** them by sharing your notes and coaching them, granting advantage when they Defy Danger to avoid the risk; and/or...
...
When you *touch a piece of aetherium and draw its power into yourself*, roll +CON: **on a 7+**, you absorb the power and gain 1d8 HP (even if this puts you above your max HP); **but on a 7-9**, the aetherium is drained and crumbles into a chalky mass of verdigris.
...
Each major arcanum is represented by a half-page insert. They are generally more potent than minor arcana, with the potential to provide multiple moves and powers. But they are also much more dangerous, and using their powers comes at the risk of ever-greater consequences.
...
You get to pick which consequence you mark. Whatever that consequence says, it happens. Don't mark a "nested" or indented consequence unless you've already marked the consequence under which it is nested; beyond that restriction, you can mark them in any order. You'll probably want to start with the ones near the top, though.

Consequences can be marked only once (or in a few cases, once per check box). There's no standard way to uncheck a consequence; they're a limited resource. Each time you mark a consequence, you must mark an empty check box.
...
- Who benefits (or would benefit) from \_\_?
- What about \_\_ isn't what it seems to be?
- How could I learn more about \_\_?
- What's the most likely outcome if \_\_?
...
- Your emotions dull. You can no longer be affected by fear, hate, or other powerful emotions (for good or ill).
...
- You draw the attention of some powerful, hungry entity of the spirit world. It has your scent. Should you destroy or bind it, erase this mark.
...
- **Tags** (like *warrior*, *stubborn*, or *tall*) that describe the follower; when you **[[14 - NPCs and Followers#ORDER FOLLOWERS|Order Followers]]**, their tags affect what you roll.
- **Damage**, **hit points**, and **[[03 - Playing the Game#Armor|armor]]**), which work the same for followers as they do for PCs.
- An **instinct**, which describes how they tend to cause trouble for you.
- **GM moves**, written as things that they can/will do (like "<sup>ä</sup> Sniff out trouble on the wind"); not every follower has these.
- A **cost**, which describes what keeps them following your lead

When you pay a follower's cost, they hold Loyalty towards you. You can then spend that Loyalty to have them overcome their fear, resist their instinct or tags, or do something they don't want to do (within reason). See **[[14 - NPCs and Followers#STRENGTHEN YOUR BOND|Strengthen Your Bond]]** for details.
...
The village itself has its own playbook, a living document that changes as you play. Stonetop's **steading playbook** is reproduced starting on [[The Steading|The Steading]]

The steading playbook includes:

- The steading's size, stats, and current debilities
- Its current Surplus
- Its resources, fortifications, etc.
- The places of interest in the village Improvements that you're working on,
- and those that you've completed The village's communal assets
...
Size affects how much **[[03 - Playing the Game#Debilities|Surplus]]** is consumed each winter. If the steading becomes a *town*, you'll have advantage to **[[03 - Playing the Game#MEET WITH DISASTER|Muster]]**, **[[03 - Playing the Game#TRADE & BARTER|Pull Together]]**, and **[[03 - Playing the Game#TRADE & BARTER|Trade & Barter]]**. If it becomes a *hamlet*, you'll have disadvantage on those moves.

Stonetop starts as a *village*, home to about 300 souls. If things go poorly, it could shrink and become a *hamlet*. If you complete enough **[[03 - Playing the Game#Steading improvements|steading improvements]]**, it can become a *town*.
...
- **Special requests** for how certain content gets handled (like, "Spiders are okay, but please don't describe their legs" or "Let's say that gender norms in Stonetop are super fluid and accepting").
...
- **Defenses**: the martial prowess and readiness of the steading; how welltrained and well-armed the inhabitants are. Roll +Defenses to Deploy.

Fortunes start at +1 and change frequently during play. The other three stats start at +0. Population changes in response to the **[[03 - Playing the Game#SEASONS CHANGE|Seasons Change]]** and **[[03 - Playing the Game#MEET WITH DISASTER|Meet with Disaster]]** moves. Prosperity and Defenses increase if you complete certain **[[03 - Playing the Game#Steading improvements|improvements]]**, and decrease if you lose key resources in play.

## **Debilities**

During play, your steading can suffer debilities much like your PC can [[03 - Playing the Game#Debilities|Debilities]]. There are three steading debilities:

- *Diminished*, by injury, sickness, doubt. Take disadvantage to **[[03 - Playing the Game#DEPLOY|Deploy]]**, **[[03 - Playing the Game#MEET WITH DISASTER|Muster]]**, or **[[03 - Playing the Game#PULL TOGETHER|Pull Together]]**.
- *Lacking*, due to shortages, hoarding, distrust. Treat Prosperity as if it's 1 lower than it is.
- *Malcontent*, from fear, anger, and/or despair. Fortunes reset to +0 each season, instead of +1 [[03 - Playing the Game#SEASONS CHANGE|Seasons Change]], and folks need Persuading more often than usual.
...
Steading debilities last until a move like **[[10 - Expeditions#RETURN TRIUMPHANT|Return Triumphant]]** says to clear them, or until the GM tells you to.

## **Surplus**

Surplus represents food in the granary and in household larders, livestock ready for slaughter, whisky that's ready to drink, fur that's ready to trade or be fashioned into garments. It's a resource that you accumulate, consume, and spend.

At the start of play, Stonetop holds 1 Surplus; there's no upper limit. The village generates Surplus each summer and autumn, and consumes Surplus each winter. You can gain more Surplus through trade, by going on an expedition to hunt big game, or as a good result when **[[03 - Playing the Game#SEASONS CHANGE|Seasons Change]]**. You can spend Surplus to trade for other assets or to have folks **[[03 - Playing the Game#PULL TOGETHER|Pull Together]]** on a project.
...
Next to the steading's Defenses, you'll see a list of fortifications and other elements that help keep the village safe (the village militia, the Ringwall, etc.)
...
Some improvements incur ongoing costs. For example, the Weapons of War improvement requires 1 Surplus every spring to maintain. If you fail to pay that cost, you lose the improvement. **[[03 - Playing the Game#MAKE A PLAN|Make a Plan]]** with the GM if you want to get it back.

The GM can threaten or harm steading improvements the same way they can threaten anything else you care about. If you don't do something to save it, it will be lost and you'll lose its benefits. Again, **[[03 - Playing the Game#MAKE A PLAN|Make a Plan]]** if you want to get it back.
...
If you want to take any of these assets on an expedition, you must first **Requisition** them [[03 - Playing the Game#REQUISITION|Requisition]].
...
Remember, if a move calls for a roll and doesn't say what happens on a 6-, **[[03 - Playing the Game#XP|mark XP]]** **and prepare for the worst**.
...
For more information, see [[06 - Player Moves#AID|Aid]].
...
For more information, see [[06 - Player Moves#CLASH|Clash]].
...
For more information, see [[06 - Player Moves#DEFEND|Defend]].
...
For more information, see [[06 - Player Moves#DEFY DANGER|Defy Danger]].
...
For more information, see [[06 - Player Moves#INTERFERE|Interfere]].
...
For more information, see [[06 - Player Moves#KNOW THINGS|Know Things]].
...
For more information, see [[06 - Player Moves#LET FLY|Let Fly]].
...
For more information, see [[06 - Player Moves#PERSUADE (vs. NPCs)|PERSUADE (vs. NPCs)]].
...
For more information, see [[06 - Player Moves#PERSUADE (vs. PCs)|PERSUADE (vs. PCs)]].
...
For more information, see [[06 - Player Moves#SEEK INSIGHT|Seek Insight]].
...
For more information, see [[06 - Player Moves#ADVANTAGE/DISADVANTAGE|Advantage/disadvantage]].
...
For more information, see [[06 - Player Moves#BURN BRIGHTLY|Burn Brightly]].
...
For more information, see [[06 - Player Moves#END OF SESSION|End of Session]].

## **Follower moves**

These moves apply when you interact with your **[[03 - Playing the Game#Followers|followers]]**.
...
For more information, see [[14 - NPCs and Followers#STRENGTHEN YOUR BOND|Strengthen Your Bond]].
...
For more information, see [[10 - Expeditions#CHART A COURSE|Chart a Course]].
...
For more information, see [[10 - Expeditions#OUTFIT|Outfit]].
...
For more information, see [[10 - Expeditions#REQUISITION|Requisition]].
...
For more information, see [[10 - Expeditions#HAVE WHAT YOU NEED|Have What You Need]].

#### **RECOVER**

When you *take time to catch your breath and tend to what ails you*,

expend 1 use of supplies and recover HP equal to 4+Prosperity. You can't gain this benefit again until you take more damage.
...
For more information, see [[10 - Expeditions#STRUGGLE AS ONE|Struggle As One]].
...
For more information, see [[10 - Expeditions#KEEP COMPANY|Keep Company]].
...
For more information, see [[07 - Harm and Healing#MAKE CAMP|Make Camp]] and [[10 - Expeditions#MAKE CAMP|Make Camp]].
...
For more information, see [[10 - Expeditions#FORAGE|Forage]].

**RETURN TRIUMPHANT** When you *return home in triumph*, having saved your fellows, put down the threat, seized the opportunity, etc., then clear one of the steading's debilities (*diminished*, *lacking*, or *malcontent*). If the steading has no debilities marked, then increase Fortunes by 1.

For more information, see [[10 - Expeditions#What if they… don't?|What if they… don’t?]].
...
*efforts might apply*, you may spend 1
...
For more information, see [[07 - Harm and Healing#CONVALESCE|Convalesce]].

## **DEPLOY**

When you *send a steading's people into danger or rally them against an attack*, roll +Defenses: **on a 10+**, it goes as well as can be expected; **on a 7-9**, it works but someone chooses 1 from the list below. If the steading is acting from a position of strength, you choose. Otherwise, the GM chooses.
...
For more information, see [[15 - Homefront#DEPLOY|Deploy]].
...
For more information, see [[15 - Homefront#LEVEL UP|Level Up]].
...
For more information, see [[15 - Homefront#MAKE A PLAN|Make a Plan]].
...
For more information, see [[15 - Homefront#MUSTER|Muster]].

For more information, see [[15 - Homefront#MEET WITH DISASTER|Meet with Disaster]].
...
For more information, see [[15 - Homefront#PULL TOGETHER|Pull Together]].
...
For more information, see [[15 - Homefront#TRADE & BARTER|Trade & Barter]].

## **SEASONS CHANGE**

 When *spring bursts forth upon the land*, whoever is the most hopeful rolls +Fortunes: **on a 10+**, pick 1 seasonal gain; **on a 7-9**, pick 1 seasonal gain, but a threat to the steading makes itself known or gets worse; **on a 6-**, threats abound (and don't mark XP).
 Whatever the result, reset Fortunes to +1.

 When *the hot days of summer settle across the land*, whoever is most content rolls +Fortunes: **on a 10+**, pick 2 seasonal gains; **on a 7-9**, pick 1 seasonal gain; **on a 6-**, a threat to the steading makes itself known or gets worse (and don't mark XP).
Whatever the result, the steading generates 1d4-1 Surplus. Then, reset Fortunes to +1.

 When *autumn falls and the land is ripe for harvest*, whoever is most determined rolls +Fortunes: **on a 10+**, pick 1 seasonal gain; **on a 7-9**, pick 1 seasonal gain, but a threat to the steading makes itself known or gets worse; **on a 6**-, threats abound (and don't mark XP).
Whatever the result, reset Fortunes to +1.
When *the harvest is complete*, roll 1d4; the steading generates that much Surplus.
For more information, see [[15 - Homefront#Seasons Change|Seasons Change]].

  When *winter grips the land*, whoever is weariest rolls

1d4+Population; the steading consumes that much Surplus. If there's not enough, reduce Surplus to 0 and Meet with Disaster. Then, pick 1:
...
When you Outfit for an expedition [[03 - Playing the Game#OUTFIT|Outfit]], you'll fill out your Inventory insert. Mark the  $\diamondsuit$ ,  $\diamondsuit\diamondsuit$ , or  $\square$  next to an item to indicate you are carrying it.
...
When you Outsit, mark \( \sigma \) below

When you Have What You Need,

move of from here to items below,

or expend supplies to mark an

W Knife or dagger, iron (band)

□ Sling (near, reload, awkward,

 $\bigcirc$  low ammo,  $\bigcirc$  all out) □ Rushlight (lasts ~15-30
...
Items that have a  $\diamondsuit$  or  $\diamondsuit\diamondsuit$  in front of them contribute to your load. Count the total number of  $\diamondsuit$  that you have marked. If you have...

- ... up to 3 �, then you have a **light load**, able to move quick and quiet;
- ... 4 to 6 &, then you have a normal load;
- ... 7 to 9 ★, then you have a heavy load—you're noisy, slow, hot, and quick to tire.
...
Your load has no specific effect, but it's part of your **[[03 - Playing the Game#The GM, dice, and moves|fictional positioning]]**. For example, the GM might say, "Vahid, you're carrying a heavy load, right? That seems like Defying Danger to me, the danger being that you exhaust yourself in this heat." Or, "Ooh, a 7? Well, you slip past without them getting spotted, but your gear jingles and one of them looks up, suspicious. She's coming to investigate. What do you do?"

If you carry 10 \(\psi\) or more, or something very heavy or awkward, then not only do you have a heavy load but you risk exhaustion, accident, and injury. The GM will tell you the consequences and/or requirements of being overloaded.
...
If you pick up any items in the field (like loot), or if an ally gives some of their gear to you, add it to your Inventory, marking the appropriate  $\diamondsuit$ . This might change your load!

You and Vahid arrive at the Ruined Tower that night, and you use up your 
...
When you **[[03 - Playing the Game#OUTFIT|Outfit]]**, you can mark a number of small items equal to 4 plus Stonetop's current Prosperity (+0 by default). If you want more small items, then bring  $\diamondsuit$  **[[03 - Playing the Game#Supplies|supplies]]**.

If you acquire a new small item on an expedition, add it to your Inventory in one of the blanks in the Small items section. There's no hard limit to the number of small items you can carry, but be reasonable. If you start stockpiling, the GM might say that your small items count as  $\mathscr{C}$  or even  $\mathscr{C}$  in aggregate.

When you Outfitted for your trip to the Ruined Tower, you marked 4 small items (because Stonetop's Prosperity is currently +0).

As you explored the upper levels, you found a jagged shard of makerglass, sharp as anything and impossible to break. It's not much bigger than a coin, a small item. You pack it into your tinderbox, and add "" makerglass shard" to your Inventory insert.

## Undefined items

You don't have to define your items up front. When you **[[03 - Playing the Game#OUTFIT|Outfit]]**, you can put some or all of your marks in the "Undefined" areas of your Inventory insert. These represent items that your PC has on their person, but which you (the player) have not yet established in the fiction.

At any point, you can **[[03 - Playing the Game#STRUGGLE AS ONE|Have What You Need]]** and transfer marks from
one of the two "Undefined" areas to a specific item. The specific item can be anything
already printed on the Inventory insert, any
common, mundane item, or any of your special possessions—but it must be something
you could have had with you all along.

The idea is: don't waste time at the table fretting over what specific items you might need to bring. Mark only items that you know you want to bring, and then put all your other marks in "Undefined." Your PC is a competent person who knows about the world they live in, and what they might need for any given journey.

When you Outfitted, you marked & supplies, a & shovel, & firewood, and undefined & . Under "Small items," you marked a dagger, a tinderbox, the locket with Morwenna's hair (a special possession), and undefined .

As you explored the upper levels of the Ruined Tower, you turned your last undefined mark under "Small items" into chalk, leaving marks as you explored.

When the beznpol attacked, you turned one of your undefined & into a & spear.
...
By default, one of supplies contains 4 uses, but you add Stonetop's current **[[03 - Playing the Game#Steading stats|Prosperity]]** to that. So if Stonetop's Prosperity is currently +1, then each of supplies contains 5 uses instead of 4.

Use supplies to:

- **[[03 - Playing the Game#STRUGGLE AS ONE|Recover]]**
- **[[03 - Playing the Game#MAKE CAMP|Make Camp]]**
- **[[03 - Playing the Game#STRUGGLE AS ONE|Have What You Need]]** to produce additional small items
...
If you're low on supplies, you can **[[10 - Expeditions#FORAGE|Forage]]** and acquire up to 2d6 uses of <sup>4</sup> provisions. You might also gain them incidentally (if, say, you fight an angry boar and harvest the meat).

Expend provisions in place of supplies when you Make Camp, or to feed yourself as you travel. Provisions, though, are more likely to spoil or attract beasts than supplies are.

*You've skinned the beznpol, and it seems wasteful to just leave the flesh. You Know Things [[03 - Playing the Game#INTERFERE|Interfere]] to see if they're good eating, and get a 7. "Well, you don't know about beznpol," says the GM, "but hunters will often eat the liver or heart of a beast fresh after the kill. That'd count as, oh, 3 uses of provisions. But you'll have to roll the Die of Fate to see if it makes you sick."* 
...
When you return home, clear the marks from your Inventory insert; it rarely matters what you're carrying while you're in town. If it does matter, assume that you have a light load (up to 3 4) and a handful of small items unless there's a good reason to think otherwise.

## **Special possessions**

Your special possessions are the things that you own or have access to, but which others do *not*. A shield, spear, a cloak, a pair of snow shoes, a cookpot—every household has these, so they are common items. But few (if any) folks in town possess a sword, or parchment and ink, or an anvil, tongs, and bellows. Any of those would be special possessions.
...
- ... **[[03 - Playing the Game#TRADE & BARTER|Trading & Bartering]]**.

Track your special possessions on your Inventory insert, in an appropriate blank. You can **[[03 - Playing the Game#OUTFIT|Outfit]]** with them, or **[[03 - Playing the Game#STRUGGLE AS ONE|Have What You Need]]** to mark them once you're in the field. Like any item, they count against your load (if they have a or ) and your starting number of small items.
...
You can, of course, freely discard a new special possession, or give it away, or trade it to another PC. But if you want to sell it to an NPC, you must roll to **[[03 - Playing the Game#TRADE & BARTER|Trade & Barter]]**.

You and Vahid trudge home. You've still got that makerglass shard, the ❤❤ bronze plaque, and the ❤ beznpol hide.

You keep the makerglass shard on your Inventory sheet (it's neat!), but give the bronze plaque (a minor arcanum) to Vahid. You erase it from your Inventory sheet; he adds it to his. You keep the beznpol hide on your insert for now, but you might try to trade it away later.
...
- A unit of trade goods\* (sack of grain, pouch of salt, stack of pelts, etc.)
- A bit of finery ( richly embroidered cloak, a silk scarf, silver comb, etc.)

## **A Value 2 item** is generally worth:

- A purse of silver coins
- A **[[03 - Playing the Game#Debilities|Surplus]]**
- A single gold coin
...
Terms in *italic* typeface are **tags**. They have no specific mechanical effect, but they are part of **[[03 - Playing the Game#The GM, dice, and moves|fictional positioning]]**. The most common tags are listed here, but others are certainly possible.
...
*area*: affects everything in an area. **[***n***] armor**: when you take damage, subtract *n*; doesn't stack.
...
*fragile*: easy to break/ruin; pack it carefully. **hours**: it lasts about an hour for each ; mark to track time used.
...
**requires \_\_\_**: if you don't meet the requirements, it works poorly or not at all.

*slow*: takes minutes or more to use; unlikely to be useful in a fight.

*thrown*: you can Let Fly with it (at *near* range).

**uses**: mark a each time you use it; it's gone/useless when they're all marked. *warm*: will keep you warm in cold weather, but it's uncomfortable and exhausting (and possibly dangerous) in hot weather.

## **Range Tags**

These indicate the distance within which a weapon/light source is effective.

*hand*: tight quarters; up close and personal. *close*: melee range, 1-2 steps away. *reach*: 3-4 steps away. *near*: up to 30 or so steps away. *far*: quite the distance; up to 100 steps,
...
When you deplete your ammo (because a move tells you to, or the GM says so), mark the next available status (left to right). When you mark " <sup>4</sup> all out," you're out of ammo and can't use that weapon until you replenish your ammunition.

## Common items

The following are commonly available, mundane items. You can **[[03 - Playing the Game#OUTFIT|Outfit]]** with them, or **[[03 - Playing the Game#HAVE WHAT YOU NEED|Have What You Need]]**. You don't need to roll anything to acquire them, though the GM might ask where you got them.
...
| ◇ **Snowshoes** | 0 |
| ◇ **[[03 - Playing the Game#Travel gear|Supplies]]** | 0 |
| **Waterskin** | 0 |
| **Whetstone** | 0 |
| **Whisky**, skin (○○ uses) | 0 |
| **Whistle** | 0 |
...
If you want to acquire any of these items, you must roll to Trade & Barter [[03 - Playing the Game#TRADE & BARTER|Trade & Barter]], and on a 7+ you must trade something of appropriate Value (which might be a favor or a debt). The GM will tell you what the other party wants.
...
| Item | Value |
|------|-------|
| **Dog**, follower (*keen-nosed*, pick 2 more): **HP** 6; **Damage** d6 (*hand*, *grabby*); **Instinct** to get distracted; **Cost** training | 1 |
| **Goat** (*sure-footed*, *curious*, *hungry*): **HP** 3; **Damage** d4 (*hand*); **Instinct** to explore; butcher for 4 provisions (○○○○○○ uses) | 1 |
| **Sheep** (*timid*, *hardy*, *wooly*): **HP** 3; **Damage** d4 (*hand*); **Instinct** to follow the herd; butcher for 4 provisions (○○○○○○ uses) | 1 |
| **Pig** (*keen-nosed*, *stubborn*, *gluttonous*, *clever*): **HP** 6; **Damage** d4 (*hand*); **Instinct** to eat anything; butcher for 4 provisions (d6+10 uses) | 1 |
| **Donkey** (*hardy*, *sure-footed*, *cautious*, *slow*): **HP** 10; **Damage** d4+2 (*hand*, *forceful*); **Instinct** to be stubborn | 2 |
| **Mule**, follower? (*large*, *hardy*, *sure-footed*, *cautious*, *keen-nosed*, *sterile*): **HP** 14; **Damage** d6+1 (*hand*, *close*); **Instinct** to avoid danger; **Cost** care & grooming | 3 |
| **Horse**, follower? (*large*, *powerful*, *keen-nosed*, *swift* or *hardy*): **HP** 10; **Damage** d6+3 (*hand*, *close*, *forceful*); **Instinct** to panic; **Cost** care & grooming | 3 |
...
- Undertake an expedition on behalf of the village and **[[10 - Expeditions#RETURN TRIUMPHANT|Return Triumphant]]**.
...
- Choose "unexpected bounty" when you get a **[[03 - Playing the Game#Seasonal gainsSeasonal gain|seasonal gain]]**.
- Choose "trade opportunity" when you get a seasonal gain, and suggest that you'd like to trade for extra Surplus.
- Undertake an expedition to hunt big game: elk, wisents, cave bears, ceirwmawr, etc.
- Buy some! Surplus isn't commonly available, so you'll need to **[[03 - Playing the Game#TRADE & BARTER|Trade & Barter]]** to see if it's available from a passing merchant. If it's not, you'll need to travel to a neighboring steading. Surplus is Value 2, so expect to pay a purse of silvers, a donkey, a barrel of fine whisky, or so forth.

If you want to increase the amount of Surplus that the village generates, look to

## **…improve Defenses**

You can temporarily boost Defenses via the **Muster** move [[03 - Playing the Game#MEET WITH DISASTER|Meet with Disaster]], but it will usually cost you Fortunes to do so. Other options include:

- Build a **[[The Steading#MARKET|Palisade]]** or a **[[The Steading#TOWNSHIP|Stone Wall]]**. They grant advantage to Deploy rolls when you take advantage of them.
- Establish a **[[The Steading#TOWNSHIP|Standing Watch]]**. They add +1 to your Defenses when they're involved.
- Spend time drilling the villagers, turning them into a **[[The Steading#TOWNSHIP|Well-Trained Militia]]**. If you train the militia in 2 or more tactics, Defenses increases by 1.
- Furnish the village with **[[The Steading#TOWNSHIP|Weapons of War]]** and teach folks to use them. This increases Defenses by 1 and gives PCs access to better weaponry.

## **… increase Population**

Choose "population boom" when you get a **[[03 - Playing the Game#Seasonal gainsSeasonal gain|seasonal gain]]**.

Alternatively, go out and save or recruit or capture a bunch of people and bring them back to live in your village.

Careful: higher Population makes it easier to **[[03 - Playing the Game#MEET WITH DISASTER|Muster]]** and **[[03 - Playing the Game#TRADE & BARTER|Pull Together]]**, but it also means more mouths to feed in winter when **[[03 - Playing the Game#SEASONS CHANGE|Seasons Change]]**.

## **… improve Prosperity**

Pursue the **[[The Steading#EXPANDED TRADES|Expanded Trades]]** and/or the **[[The Steading#MARKET|Market]]** improvement. Each of these increase Prosperity by 1, as long as they're maintained.

Also, the **Township** improvement [[The Steading#TOWNSHIP|Township]] grants advantage when you **[[03 - Playing the Game#TRADE & BARTER|Trade & Barter]]**.

## **… unlock a steading improvement**

Look at the requirements and choose one to pursue. If you don't know how to pursue it, **[[03 - Playing the Game#INTERFERE|Know Things]]** and/or **[[03 - Playing the Game#MAKE A PLAN|Make a Plan]]**.
...
You can **[[03 - Playing the Game#OUTFIT|Outfit]]** or **[[03 - Playing the Game#STRUGGLE AS ONE|Have What You Need]]** to produce a handful of coppers, but if you want more significant quantities, or any quantity of silver or gold coins, then you'll need to roll **[[03 - Playing the Game#TRADE & BARTER|Trade & Barter]]** to see if they're even available. Even if they are, you'll need to trade something of an appropriate Value.
...
**[[03 - Playing the Game#INTERFERE|Know Things]]**! Maybe you know where something like that might be found. If you don't, try something else:
...
- Put the word out. Let merchants and other contacts know that you're interested in that sort of thing, then choose "trade opportunity" or "interesting news" when you get a **[[03 - Playing the Game#Seasonal gainsSeasonal gain|seasonal gain]]**.

# **… unlock the mysteries of an arcanum**

Do what the requirements say! If you're not sure how to meet a requirement, roll to **[[03 - Playing the Game#INTERFERE|Know Things]]** and/or talk to the GM and **[[03 - Playing the Game#MAKE A PLAN|Make a Plan]]**.

## **… recruit followers**

If you have someone in mind, ask them to join you on an expedition. **Persuade** them if necessary [[03 - Playing the Game#SEEK INSIGHT|Seek Insight]].

If you don't have someone in mind, tell the GM what sort of follower you're looking for ("a skilled tracker," "a knowledgeable guide," "someone who can handle themselves in a fight," etc.). They'll either tell you who in town fits the bill, or ask you to make someone up, or suggest that you **[[03 - Playing the Game#INTERFERE|Know Things]]**.

#### Alternatively:

- **[[03 - Playing the Game#MEET WITH DISASTER|Muster]]** and pick "1 or 2 individuals show real potential." Let the GM know that you're hoping for a follower, and they'll probably work with you.
